...
public class Conexao {
    ...
    private static final String USUARIO = "postgres"; // Geralmente o usuário padrão é "postgres"
    private static final String SENHA = "ca182730"; // Deve ser substituído pela senha real do banco de dados
